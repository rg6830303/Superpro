...
async function createIntro({forceFallback=false}={}) {
  ...
  const arms=[-1,1].map(side=>({
    ...
    palm:ellipsoid(1,[.098,.115,.052],skin,[0,0,0]),
    knuckle:ellipsoid(1,[.10,.042,.055],skin,[0,0,0]),
  ...
  const poses=[
    ...
    {t:0,wrist:-0.35,y:0,turn:-.32,tw:.10,crunch:.02,side:0,hp:.06,lean:.04,
    ...
    {t:.75,wrist:-1.15,y:-.15,turn:-.48,tw:-.42,crunch:-.06,side:.05,hp:.16,lean:.11,
    ...
    {t:1.35,wrist:-1.4,y:.47,turn:-.52,tw:-.58,crunch:-.14,side:.08,hp:.22,lean:-.14,
    ...
    {t:1.68,wrist:-1.05,y:.56,turn:-.16,tw:-.30,crunch:-.05,side:.04,hp:.18,lean:-.04,
    ...
    {t:1.91,wrist:0.12,y:.55,turn:.10,tw:.34,crunch:.06,side:-.02,hp:.05,lean:.06,
    ...
    {t:2.02,wrist:1.05,y:.46,turn:.34,tw:.48,crunch:.18,side:-.06,hp:-.06,lean:.13,
